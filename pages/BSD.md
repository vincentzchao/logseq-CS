alias:: Berkeley Software Distribution
...
- # BSD
	- ## 第三方资料
		...
		- ---
		- ## 1. What is BSD? [](https://docs.freebsd.org/en/articles/explaining-bsd/#what-is-bsd)
		...
		- The X Window system used in most versions of BSD is maintained by the [X.Org project](http://www.x.org/). FreeBSD allows the user to choose from a variety of desktop environments, such as Gnome, KDE, or Xfce; and lightweight window managers like Openbox, Fluxbox, or Awesome.
		- -
		- Many other programs and utilities.
		- ## 2. What, a real UNIX®? [](https://docs.freebsd.org/en/articles/explaining-bsd/#what-a-real-unix)
		...
		- ## 3. Why is BSD not better known? [](https://docs.freebsd.org/en/articles/explaining-bsd/#why-is-bsd-not-better-known)
		...
		- ## 4. Comparing BSD and Linux [](https://docs.freebsd.org/en/articles/explaining-bsd/#comparing-bsd-and-linux)
		...
		- ### 4.1. Who owns BSD? [](https://docs.freebsd.org/en/articles/explaining-bsd/#_who_owns_bsd)
		...
		- ### 4.2. How is BSD developed and updated? [](https://docs.freebsd.org/en/articles/explaining-bsd/#_how_is_bsd_developed_and_updated)
		...
		- ### 4.3. BSD releases [](https://docs.freebsd.org/en/articles/explaining-bsd/#_bsd_releases)
		...
		- ### 4.4. What versions of BSD are available? [](https://docs.freebsd.org/en/articles/explaining-bsd/#_what_versions_of_bsd_are_available)
		...
		- ### 4.5. How does the BSD license differ from the GNU Public license? [](https://docs.freebsd.org/en/articles/explaining-bsd/#_how_does_the_bsd_license_differ_from_the_gnu_public_license)
		...
		- ### 4.6. What else should I know? [](https://docs.freebsd.org/en/articles/explaining-bsd/#_what_else_should_i_know)
		...
		- ### 4.7. Which should I use, BSD or Linux? [](https://docs.freebsd.org/en/articles/explaining-bsd/#_which_should_i_use_bsd_or_linux)
		...
		- ### 4.8. Who provides support, service, and training for BSD? [](https://docs.freebsd.org/en/articles/explaining-bsd/#_who_provides_support_service_and_training_for_bsd)
		- BSDi / [FreeBSD Mall, Inc.](http://www.freebsdmall.com/) have been providing support contracts for FreeBSD for nearly a decade.
		...
		- ---
		- **Last modified on**: November 3, 2021 by [Sergio Carlavilla Delgado](https://cgit.freebsd.org/doc/commit/?id=64acd169b8)
		- #+BEGIN_EXPORT hiccup
		  [:aside {} [:div {} [:h3 {} "Table of Contents"] [:nav {:id "TableOfContents"} [:ul {} [:li {} [:a {:href "https://docs.freebsd.org/en/articles/explaining-bsd/#what-is-bsd"} "1. What is BSD?"]] [:li {} [:a {:href "https://docs.freebsd.org/en/articles/explaining-bsd/#what-a-real-unix"} "2. What, a real UNIX®?"]] [:li {} [:a {:href "https://docs.freebsd.org/en/articles/explaining-bsd/#why-is-bsd-not-better-known"} "3. Why is BSD not better known?"]] [:li {} [:a {:href "https://docs.freebsd.org/en/articles/explaining-bsd/#comparing-bsd-and-linux"} "4. Comparing BSD and Linux"]]]] [:hr {}] [:div {} [:h3 {} "Resources"] [:ul {} [:li {} [:i {:aria-hidden "true", :title "Download PDF"}] [:a {:href "https://download.freebsd.org/doc/en/articles/explaining-bsd/explaining-bsd_en.pdf"} "Download PDF"]] [:li {} [:i {:aria-hidden "true", :title "Edit this page"}] [:a {:href "https://github.com/freebsd/freebsd-doc/edit/main/documentation/content/en/articles/explaining-bsd/_index.adoc", :target "_blank"} "Edit this page"]]]]]]
		  #+END_EXPORT
		- #+BEGIN_EXPORT hiccup
		  [:footer {} [:div {} [:section {} [:img {:src "https://docs.freebsd.org/images/FreeBSD-colors.svg", :width "160", :height "50", :alt "FreeBSD logo"}] [:div {} [:div {} [:a {:id "languages", :href "https://docs.freebsd.org/en/languages"} [:img {:src "https://docs.freebsd.org/images/language.png", :alt "Choose language"}] [:span {} "English"]]] [:div {} [:select {:id "theme-chooser"} [:option {:value "theme-light"} "Light"] [:option {:value "theme-dark"} "Dark"] [:option {:value "theme-high-contrast"} "High contrast"]]]]] [:section {} [:h3 {} "About"] [:ul {} [:li {} [:a {:href "https://www.freebsd.org/about/", :target "_blank"} "FreeBSD"]] [:li {} [:a {:href "https://freebsdfoundation.org/", :target "_blank"} "FreeBSD Foundation"]] [:li {} [:a {:href "https://www.freebsd.org/where/", :target "_blank"} "Get FreeBSD"]] [:li {} [:a {:href "https://www.freebsd.org/internal/code-of-conduct", :target "_blank"} "Code of Conduct"]] [:li {} [:a {:href "https://www.freebsd.org/security/", :target "_blank"} "Security Advisories"]]]] [:section {} [:h3 {} "Documentation"] [:ul {} [:li {} [:a {:href "https://docs.freebsd.org/en"} "Documentation portal"]] [:li {} [:a {:href "https://man.freebsd.org/", :target "_blank"} "Manual pages"]] [:li {} [:a {:href "https://papers.freebsd.org/", :target "_blank"} "Presentations and papers"]] [:li {} [:a {:href "https://docs-archive.freebsd.org/doc/", :target "_blank"} "Previous versions"]] [:li {} [:a {:href "https://docs-archive.freebsd.org/44doc/", :target "_blank"} "4.4BSD Documents"]] [:li {} [:a {:href "https://wiki.freebsd.org/", :target "_blank"} "Wiki"]]]] [:section {} [:h3 {} "Community"] [:ul {} [:li {} [:a {:href "https://docs.freebsd.org/en/articles/contributing"} "Get involved"]] [:li {} [:a {:href "https://forums.freebsd.org/", :target "_blank"} "Community forum"]] [:li {} [:a {:href "https://lists.freebsd.org/", :target "_blank"} "Mailing lists"]] [:li {} [:a {:href "https://wiki.freebsd.org/IRC/Channels", :target "_blank"} "IRC Channels"]] [:li {} [:a {:href "https://bugs.freebsd.org/bugzilla/", :target "_blank"} "Bug Tracker"]]]] [:section {} [:h3 {} "Legal"] [:ul {} [:li {} [:a {:href "https://freebsdfoundation.org/donate/", :target "_blank"} "Donations"]] [:li {} [:a {:href "https://www.freebsd.org/copyright/freebsd-license/", :target "_blank"} "Licensing"]] [:li {} [:a {:href "https://www.freebsd.org/privacy/", :target "_blank"} "Privacy Policy"]] [:li {} [:a {:href "https://www.freebsd.org/copyright/", :target "_blank"} "Legal notices"]]]] [:section {} [:p {} "© 1994-2023 The FreeBSD Project. All rights reserved"] [:span {} "Made with" [:span {} " "] [:span {} "♥"] [:span {} " "] "by the FreeBSD Community"]]]]
		  #+END_EXPORT
-